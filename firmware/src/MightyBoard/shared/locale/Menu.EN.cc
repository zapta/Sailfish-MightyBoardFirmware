...
const PROGMEM prog_uchar RELOADING_UNLOADING_MSG[] = "UNLOADING..." ;
const PROGMEM prog_uchar RELOADING_WAIT_MSG[] = "INSERT FILAMENT     " "                    " "                    " "Press OK to continue" ;
const PROGMEM prog_uchar RELOADING_LOADING_MSG[] = "LOADING..." ;
