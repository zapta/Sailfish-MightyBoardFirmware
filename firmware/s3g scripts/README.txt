...
Edit: July 2017, can use the Mac OSX command line x3g tool in the 'gcode'
directory of this repository (need to figure out exact flags to use). 
...
* Generate the .x3g file using the toolbar icon 'Build to file for use with SD card'.
